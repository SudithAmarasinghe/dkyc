...
# # API_BASE_URL = "http://157.157.221.29:34119"  # Change this to your actual API URL
# #
...
# # tab1, tab2 = st.tabs(["Submit Verification", "Check Status"])
# #
# # with tab1:
...
# #     3. **Enable auto-refresh** to automatically monitor processing status
# #
# #     The system will:
...
# except ImportError:
#     st.error("Admin functionality requires kyc_storage.py file. Please ensure it's in the same directory.")
...
#     if not ADMIN_AVAILABLE:
#         st.error("Admin panel requires MinIO connection. Please check kyc_storage.py")
#         return
#
